...
//document.querySelector('#asteroid').innerHTML = asteroid.orbital_data.orbit_class.orbit_class_range;
//document.querySelector('#asteroid').innerHTML = asteroid.estimated_diameter.kilometers.estimated_diameter_min;

document.querySelector('#asteroid').innerHTML = "The asteroid named " + asteroid.name + " is between " + 
asteroid.estimated_diameter.miles.estimated_diameter_min + " and " + 
asteroid.estimated_diameter.miles.estimated_diameter_max + " miles wide, and will miss striking Earth by approximately " 
+ asteroid.close_approach_data[0].miss_distance.miles + " miles."

document.querySelector('#asteroidLink').href = asteroid.links.self;